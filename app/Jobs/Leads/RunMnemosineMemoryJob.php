...
use App\Agents\Memory\MnemosineAgent;
...
class RunMnemosineMemoryJob implements ShouldBeUnique, ShouldQueue
{
    use Queueable;
    ...
    public function handle(MnemosineAgent $agent, LeadStateMachine $stateMachine): void
    {
        ...
        $stateMachine->transition($lead, LeadStatus::PendingHumanReview, 'agent', $result->agent);
    }

    public function failed(Throwable $exception): void
    {
        LeadPipelineFailure::handle($this->leadId, 'Mnemosine', $exception);
    }
}
